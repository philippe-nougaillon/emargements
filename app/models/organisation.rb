class Organisation < ApplicationRecord
  ...
  def tags
    assemblees_tags_ids = current_user.organisation.assemblees.tag_counts_on(:tags).pluck(:id)
    users_tags_ids = current_user.organisation.users.tag_counts_on(:tags).pluck(:id)
