...
ActiveRecord::Schema[7.1].define(version: 2024_04_16_125131) do
  ...
  create_table "assemblees", force: :cascade do |t|
    t.datetime "début"
  ...
  create_table "mail_logs", force: :cascade do |t|
    ...
    t.index ["slug"], name: "index_mail_logs_on_slug", unique: true
  end
